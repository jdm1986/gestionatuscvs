        ...
        .then(data => {
            ...
            data.forEach(curriculum => {
                ...
                row.innerHTML = `
                    ...
                    <td>${curriculum.fechaInsercion || 'N/A'}</td>
                    <td>${curriculum.sexo}</td>
                    <td><img src="path/to/thumbnails/${curriculum.pdfPath}" class="img-thumbnail" onclick="window.open('path/to/pdf/${curriculum.pdfPath}', '_blank')"></td>
