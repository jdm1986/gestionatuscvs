...
// Indico que esta es una clase de configuración para la parte MVC de mi aplicación
@Configuration
public class WebMvcConfig implements WebMvcConfigurer {

    // Defino un controlador de vista para redirigir la raíz de mi aplicación hacia el archivo index.html
    @Override
